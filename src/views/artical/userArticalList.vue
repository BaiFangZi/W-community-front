			...
			<el-table :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))" style="width: 100%">
				<el-table-column prop="date">
					<template slot="header" slot-scope="scope">
						<el-button type="success" plain style="padding: 10px 20px;" @click="cerateArtical">发布文章</el-button>
						<el-button type="success" plain style="padding: 10px 20px;" @click="cerateProblem">发布问题</el-button>
					</template>
				</el-table-column>
