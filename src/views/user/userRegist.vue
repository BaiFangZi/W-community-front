<template>
	<el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="80px" class="form-regist">
		...
		<el-form-item label="验证码" prop="verifyCode"><el-input v-model.number="ruleForm.verifyCode"></el-input></el-form-item>
		<el-form-item label="">
			<div class="verifyImg">
...
.form-regist .verifyImg {
	width: 300px;
	height: 40px;
	/* background-color: gray; */
}
.form-regist .verifyImg img {
	width: 150px;
	height: 100%;
}
.form-regist .verifyImg span {
	margin: 10px;
}
.form-regist .verifyImg span:hover {
	color: #409eff;
}
</style>
